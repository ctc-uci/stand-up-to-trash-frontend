...
const AddEventsModal = () => {
    ...
    const dateParser = (dateString) => {
        ...
        emptyDate.setFullYear(parseInt(year, 10));
        emptyDate.setMonth(parseInt(month, 10) - 1);
        emptyDate.setDate(parseInt(day, 10));
    }

    const timeParser = (timeString) => {
        const emptyDate = new Date();
        const [hours, minutes] = timeString.split(':');
        emptyDate.setHours(parseInt(hours, 10));
        emptyDate.setMinutes(parseInt(minutes, 10));
