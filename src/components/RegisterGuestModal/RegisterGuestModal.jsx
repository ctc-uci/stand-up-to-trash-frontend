        ...
        <Modal isOpen={isOpen} onClose={onClose} size='lg'>
          ...
          <ModalContent borderRadius={'22px'} padding={5} width={'80%'} >
            ...
            <ModalHeader alignSelf={'center'} padding={50} >
              <Text fontSize={'18px'} textAlign={'center'} fontWeight={'medium'} color={'#717171'}>Add volunteer</Text>
              <Text fontWeight={'bold'} fontSize={'28px'} >Add Guest Volunteer</Text>
            </ModalHeader>
              ...
              <FormControl >
                ...
                <ModalBody >
                  <FormControl>
                    ...
                    >
                      <GridItem colSpan={1}>
                        <Text fontWeight={'medium'} fontSize={'14px'} color={'#717171'}>First Name*</Text>
                        <Input
                          marginTop={1}
                          placeholder="Johnny"
                          alignItems={'center'}
                          {...register('first_name')}
                          type="string"
                          onChange={(e) => setVolunteerData(prevState => ({
                            ...prevState,
                      ...
                      <GridItem colSpan={1}>
                        <Text fontWeight={'medium'} fontSize={'14px'} color={'#717171'}>Last Name*</Text>
                        <Input
                          marginTop={1}
                      ...
                      <GridItem colSpan={1}>
                        <Text fontWeight={'medium'} fontSize={'14px'} color={'#717171'}>Party size</Text>
                        <Input
                          marginTop={1}
                          placeholder="1"
                          alignItems={'center'}
                      ...
                      <GridItem colSpan={1}>
                        <Text fontWeight={'medium'} fontSize={'14px'} color={'#717171'}>Email</Text>
                        <Input
                          marginTop={1}
                      ...
                      <Text fontWeight={'medium'} fontSize={'14px'} color={'#717171'}>Read terms and conditions</Text>
                      <GridItem colSpan={2} height="200px" overflowY={'scroll'} border={'3px solid #EFEFEF'} borderRadius={'12px'} padding={'12px'}>
                        <Text
                          alignItems={'center'}
                      ...
                      <GridItem colSpan={2}>
                        ...
                        <Checkbox {...register('waiver')} style={{alignContent:'center', display:'flex', flexDirection:'row', width:'100%'}} onChange={(e) => setVolunteerData(prevState => ({...prevState, waiver: e.target.checked}))}>
                          I agree to the{' '}
                ...
                <Center p={8} style={{gap: '12px'}}>
                  <Button type="submit" color="#3B3B3B" bg="#EFEFEF" w="70%" h="50px" style={{borderRadius:'12px'}}>
                    Cancel
                  </Button>
                  <Button type="submit" color="white" bg="#003FE3" w="70%" h="50px" style={{borderRadius:'12px'}} _hover={{ bg: "#002B99" }} isDisabled={isFormFilled()}>
                    Add Volunteer
                  </Button>
                </Center>
              </FormControl>
