...
const RegisterGuestModal = ({ isOpen, onClose, eventId }) => {
  ...
  const isFormFilled = () => {
    return !(
      ...
      volunteerData.waiver &&
      (volunteerData.email || volunteerData.email === null) // Considering email can be null
    );
  };
                ...
                <FormControl>
                  ...
                  >
                    ...
                    <GridItem colSpan={2}>
                      ...
                      <Checkbox {...register('waiver')} style={{alignContent:'center', display:'flex', flexDirection:'row', width:'100%'}}>
                        I agree to the{' '}
