  ...
  return (
    <Box bg={'#e6eaee'} minHeight="100vh" paddingLeft={"15rem"}>
      ...
      <Grid templateColumns="repeat(3, 1fr)" gap={4}>
        <GridItem colSpan={1}>
          <Card bg={'white'} borderRadius={10} border={'solid #efefef'} mt={20} ml="auto" mr="2rem" w="16rem">
            <Center>
              <Image
          ...
          <Box pr="2rem" mt="20" display="flex" gap="20px" flexDirection={'column'} mr="auto">
                ...
                <Box mx="2rem">
                    <Box display="flex" flexDir={'row'} gap="2rem" w="100%">
                        ...
                        {/* Left-hand side */}
                            ...
                            <SettingsField title={"Email Address"} placeholder={"volunteer@gmail.com"} type={"email"}/>
                            <SettingsField title={"Phone Number"} placeholder={"714-322-5732"} type={"tel"}/>
                        </Box>
                        <Box w="50%">
                            {/* Right-hand side */}
                            <SettingsField title={"About Me"} placeholder={"I am a volunteer for Stand Up to Trash 🧍🗑️!"} textarea={true}/>
            ...
            <SettingsCard icon={<RiErrorWarningFill />} title="Account Access">
              <Box display={"flex"} flexDir={'row'} gap="2rem" w="100%">
                ...
                <Box w="20%">
                  <Button mt={4}   colorScheme='black' variant='outline' size='sm'>Sign Out</Button>
                  <Button mt={8} colorScheme='red' size='sm'>Delete account</Button>
                </Box>
              </Box>
            </SettingsCard>
          </Box>
