import { Box, Stack, Button, Input, Text, Flex, VStack, InputGroup, InputLeftElement} from '@chakra-ui/react';
    ...
    return (
      <>
        ...
        <Flex direction="column" ml="15rem" bg="#E8EDF3" p='10' gap='10' >
            ...
            <Flex direction={{ base: 'column', md: 'row' }} bg="F8F8F8" w='100%' gap={10} justifyContent='center' mt={5}>
                ...
                {/* Leaderboard Card */}
                <VStack bg="white" p={30} align="center" w='70%' spacing={5}>
                  <Text fontWeight={'medium'} fontSize={24}>
                    Leaderboard
                  </Text>
                  <Text textColor='#0075FF' as='b' bg="#D4E4F9" padding='3' fontSize='lg'>
                    <TrophyIcon marginRight='2' />
                    1. {topThree[0] && topThree[0].volunteer_first_name}{' '}
                    {topThree[0] && topThree[0].volunteer_last_name} ...........{' '}
                    {topThree[0] && truncate(topThree[0].total_weight, 2)} lbs
                  </Text>
                  <Text>
                    2. {topThree[1] && topThree[1].volunteer_first_name}{' '}
                    {topThree[1] && topThree[1].volunteer_last_name} ............{' '}
                    {topThree[1] && truncate(topThree[1].total_weight, 2)} lbs
                  </Text>
                  <Text>
                    3. {topThree[2] && topThree[2].volunteer_first_name}{' '}
          ...
          <Box padding='10' bg="#F8F8F8" borderRadius="md">
              <Stack spacing={4}>
                  <Text fontSize='4xl' as='b' >All Volunteers</Text>
                  <InputGroup mt={10}>
